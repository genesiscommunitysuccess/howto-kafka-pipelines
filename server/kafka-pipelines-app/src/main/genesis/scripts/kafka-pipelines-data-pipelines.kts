...
pipelines {
    pipeline("KAFKA_TO_DB_PIPELINE") {
        ...
        source(source)
            ...
            // other options are: SKIP_STREAM, STOP_PIPELINE - see (https://learn.genesis.global/docs/server/data-pipelines/implementations/#on-operation-error-handler) for more info on this error handler
